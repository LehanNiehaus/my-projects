...
clone ~ ~-1 ~ ~ ~-1 ~ 4 1 0
setblock ~ ~-1 ~ structure_block{mode:"LOAD", name:"mc_edit_dranox5:copy_0-0-0", ignoreEntities:0b, posY:1, powered:0b}
execute if entity @s[tag=ignore_entities] run data merge block ~ ~ ~ {ignoreEntities:1b}
data merge block ~ ~-1 ~ {mirror:"LEFT_RIGHT"}
