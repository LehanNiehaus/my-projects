...
scoreboard players operation @s[scores={math_input1=-1}] math_input2 %= 2 constant
...
scoreboard players set @s[scores={math_input2=..-1,math_input1=0}] math_output 0
scoreboard players operation @s[scores={math_input2=..-1}] math_output /= @s math_input1
...
scoreboard players operation @s[scores={math_input2=1..}] math_output *= @s math_input1
scoreboard players remove @s[scores={math_input2=1..}] math_input2 1
scoreboard players operation @s[scores={math_input2=1..}] math_output *= @s math_input1
scoreboard players remove @s[scores={math_input2=1..}] math_input2 1
scoreboard players operation @s[scores={math_input2=1..}] math_output *= @s math_input1
scoreboard players remove @s[scores={math_input2=1..}] math_input2 1
