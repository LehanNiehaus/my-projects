...
scoreboard players operation @s[scores={math_temp5=..-1}] math_temp5 *= -1 constant
...
scoreboard players operation @s[scores={math_input1=0..}] math_input1 -= @s math_temp5
scoreboard players operation @s[scores={math_input1=..-1}] math_input1 += @s math_temp5
scoreboard players operation @s[scores={math_input2=0..}] math_input2 -= @s math_temp5
scoreboard players operation @s[scores={math_input2=..-1}] math_input2 += @s math_temp5

scoreboard players operation @s math_temp3 = @s math_input1
scoreboard players operation @s[scores={math_input2=0..}] math_temp5 *= -1 constant
scoreboard players operation @s[scores={math_input2=0..}] math_input2 *= -1 constant
...
function math:float/multiply
scoreboard players operation @s[scores={math_temp5=0..}] math_output *= -1 constant

#Restore inputs
scoreboard players operation @s math_input1 = @s math_temp3
scoreboard players operation @s math_input2 = @s math_temp4
scoreboard players operation @s[scores={math_temp5=..-1}] math_input2 *= -1 constant
scoreboard players operation @s[scores={math_temp5=..-1}] math_temp5 *= -1 constant
scoreboard players operation @s[scores={math_input1=0..}] math_input1 += @s math_temp5
scoreboard players operation @s[scores={math_input1=..-1}] math_input1 -= @s math_temp5
scoreboard players operation @s[scores={math_input2=0..}] math_input2 += @s math_temp5
